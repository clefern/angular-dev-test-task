...
export class AppComponent implements OnInit {
	...
	crypt = new FormControl('BTC');
	crypts = Object.getOwnPropertyNames(CRYPTO_CURRENCY_CODES_AND_NAMES).sort();
	data = [
		{
		  "value": 20,
	...
	onChangeCrypt() {
		console.log(this.firebase.index(this.crypt.value, this.quantity.value));
	}
